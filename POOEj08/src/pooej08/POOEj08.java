...
public class POOEj08 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("ingresar letra para contar");
        String letra = leer.nextLine();
        System.out.println("");
        System.out.println("la letra "+" "+letra+"se encuentra"+" "+cadena.vecesRepetido(letra));
        System.out.println("...");
        
        System.out.println("ingresar frase para comparar longitud");
        ...
        System.out.println("");
        System.out.println("frases unidas: "+" "+cadena.unirFrases(frase2));
        System.out.println("...");
        
        System.out.println("ingresar letra para reemplazar la letra .a.");
        String letra2 = leer.nextLine();
        System.out.println("");
        System.out.println("Nueva frase :"+" "+cadena.reemplazarA(letra2));
        System.out.println("...");
        
        System.out.println("ingresar letra para saber si esta en la frase");
